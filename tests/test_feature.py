...
def test_line_feature():
    ...
    line_feature = geo_adjacency.adjacency.Feature(line)
...
def test_polygon_feature():
    ...
    polygon_feature = geo_adjacency.adjacency.Feature(polygon)
...
def test_feature_equality(point_geom_a):
    ...
    feature1 = geo_adjacency.adjacency.Feature(point_geom_a)
    feature2 = geo_adjacency.adjacency.Feature(point_geom_a)
