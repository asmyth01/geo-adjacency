...
def test_point_feature():
    ...
    expected = [(30.0, 10.0)]
    point_feature = adjacency._Feature(point)
...
def test_line_feature():
    ...
    line_feature = adjacency._Feature(line)
...
def test_polygon_feature():
    ...
    polygon_feature = adjacency._Feature(polygon)
...
def test_polygon_w_interior():
    poylgon_w_interior = loads("POLYGON ((35 10, 45 45, 15 40, 10 20, 35 10), (20 30, 35 35, "
                               "30 20, 20 30))")
    polygon_feature = adjacency._Feature(poylgon_w_interior)
...
def test_multipolygon_feature():
    ...
    expected = [(30.0, 20.0), (45.0, 40.0), (10.0, 40.0), (15.0, 5.0), (40.0, 10.0), (10.0, 20.0),
                (5.0, 10.0)]
    multipolygon_feature = adjacency._Feature(multipolygon)
...
def test_multipolygon_w_interior():
    multipolygon_w_interior = loads("MULTIPOLYGON (((40 40, 20 45, 45 30, 40 40)), ((20 35, "
                                    ...
                                    "30 20)))")
    multipolygon_feature = adjacency._Feature(multipolygon_w_interior)
...
def test_feature_equality():
    feature1 = adjacency._Feature(loads("POINT (30 10)"))
    feature2 = adjacency._Feature(loads("POINT (30 10)"))
    assert feature1 == feature2

def test_feature_inequality():
    feature1 = adjacency._Feature(loads("POINT (30 10)"))
    feature2 = adjacency._Feature(loads("POINT (30 11)"))
    assert feature1 != feature2