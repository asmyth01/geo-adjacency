...
from geo_adjacency.adjacency import flatten_list
...
def test_all_features():
    ...
    for geom in source_geoms:
        expected.append(adjacency._Feature(geom))
...
def test_coords_from_point():
    ...
    actual = adjacency.coords_from_point(point)
    expected = [(30.0, 10.0)]
...
def test_coords_from_ring():
    ...
    actual = adjacency.coords_from_ring(ring)
...
def test_coords_from_polygon():
    ...
    actual = adjacency.coords_from_polygon(polygon)
    ...
    poylgon_w_interior = loads("POLYGON ((35 10, 45 45, 15 40, 10 20, 35 10), (20 30, 35 35, "
                               "30 20, 20 30))")
    actual = adjacency.coords_from_polygon(poylgon_w_interior)
...
def test_coords_from_multipolygon():
    multipolygon = loads("MULTIPOLYGON (((30 20, 45 40, 10 40, 30 20)), ((15 5, 40 10, 10 20, "
                         "5 10, 15 5)))")
    actual = adjacency.coords_from_multipolygon(multipolygon)
    ...
    multipolygon_w_interior = loads("MULTIPOLYGON (((40 40, 20 45, 45 30, 40 40)), ((20 35, "
                                    ...
                                    "30 20)))")
    actual = adjacency.coords_from_multipolygon(multipolygon_w_interior)
